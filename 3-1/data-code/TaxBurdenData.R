...
cig.data <- read_csv("/Users/lisbethvargas/Desktop/GitHub/Homework-3/3-1/data/input/CDC_1970-2018.csv", col_names = TRUE)
cpi.data <- read_xlsx("/Users/lisbethvargas/Desktop/GitHub/Homework-3/3-1/data/input/CPI_1970_2018.xlsx", skip = 11)
